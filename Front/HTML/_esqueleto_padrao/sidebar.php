        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <!-- Vendas -->
                    <li class="nav-item" data-toggle="collapse" data-target="#collapseGerenciarVendas"
                    aria-expanded="false" aria-controls="collapseGerenciarVendas" >
                    ...
                    <!-- Produtos -->
                    <li class="nav-item" data-toggle="collapse" data-target="#collapseGerenciarProduto"
                    aria-expanded="false" aria-controls="collapseGerenciarProduto">
                        <a class="nav-link" href="#">
                    ...
                    <!-- Clientes -->
                    <li class="nav-item" data-toggle="collapse" data-target="#collapseGerenciarClientes"
