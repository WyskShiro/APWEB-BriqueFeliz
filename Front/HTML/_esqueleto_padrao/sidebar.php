    ...
    <div class="row">
        ...
        <nav class="main-menu d-none d-md-block bg-light h-100 ">
            ...
            <ul>
                ...
                <!-- Funcionarios -->
                <li class="has-subnav" data-toggle="collapse" data-target="#collapseGerenciarFuncionario" aria-expanded="false"
                    aria-controls="collapseGerenciarFuncionario">
                    <a href="#">
                ...
                <!-- Clientes -->
                <!-- <li class="has-subnav" data-toggle="collapse" data-target="#collapseGerenciarClientes" aria-expanded="false"
                ...
                <!-- Categorias -->
                <li class="has-subnav" data-toggle="collapse" data-target="#collapseGerenciarCategoria" aria-expanded="false"
                    aria-controls="collapseGerenciarCategoria">
                    <a href="#">
                ...
                <!-- Relatorios -->
                <!-- <li class="has-subnav" data-toggle="collapse" data-target="#collapseGerenciarRelatorios" aria-expanded="false"
                    aria-controls="collapseGerenciarRelatorios">
                    <a href="#">
